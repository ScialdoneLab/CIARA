...
We use the Matthews Correlation Coefficient (MCC) to evaluate the performance of other methods in the task of identfying the PGCs cluster from human gastrula. 
