...
test=Test_Fisher(final_cluster_version_sub,marker_elmir_all,final_sort_triku[1:1000])
...
names(cluster_id)=colnames(raw_elmir_5_30)
 Final_Clusters = CellSIUS_final_cluster_assignment(CellSIUS.out=CellSIUS_elmir_new, group_id=cluster_id, min_n_genes = 3)
...
load("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/elmir_data/final_cluster_version_sub.Rda")
test=Test_Fisher(final_cluster_version_sub,marker_elmir_all,top_values[1:1000])
...
row.names(index_dist)=marker_pgc
...
load("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/elmir_data/final_cluster_version_sub.Rda")
test=Test_Fisher(final_cluster_version_sub,marker_elmir_all,sam_genes[1:1000])
