...
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/umap_endoderm_mouse.pdf",width = 8, height = 6)
...
plot_balloon_marker(norm_data_heart,final_cluster_heart,top_heart,10,max_size=2,text_size=9)
dev.off()
```
...
#names(top_heart)=rep("YSE1",length(top_heart))
#names(top_endo)=rep("YSE1",length(top_endo))
#geni_comuni=intersect(top_heart,top_endo)
...
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/markers_endo_mouse.pdf",width = 8, height = 6)
#plot_balloon_marker_here(norm_data_heart,final_cluster_heart_new,geni_comuni,10,max_size=12,text_size=25)
plot_balloon_marker_norm(norm_data_heart,final_cluster_heart_new,geni_comuni,10,max_size=12,text_size=25)
dev.off()
```
...
listInput <- list(YSE1_mouse=marker_heart[names(marker_heart)=="2-step_2"],YSE1_human=marker_endoderm_2)
...
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/enrichment_mouse_endo.pdf",width = 8, height = 6)
...
##Mega comprsion with mouse and human
...
#load(file="markers_first_elmir_final.Rda")
marker_elmir_all=markers_first_elmir_final[[3]]
marker_mega_human=marker_elmir_all[names(marker_elmir_all)=="Hemogenic Endothelial Progenitors_4"]
...
#pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figure_4/figure_4_g.pdf")
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/enrichment_mouse_mega.pdf",width = 8, height = 6)
upset(fromList(listInput), order.by = "freq")
dev.off()
...
```
```{r }
cluster_test=names(marker_elmir_all)
result=Test_Fisher(marker_elmir_all,mega_mouse_small,as.vector(marker_elmir_all),cluster_test)
