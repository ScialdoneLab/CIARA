...
## Save input data for cran (not run)
...
#hvg_human_gastrula=elmir_seurat_5@assays$RNA@var.features
setwd("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/CIARA_archive/CIARA_old/inst/extdata")
save(hvg_human_gastrula,file="hvg_human_gastrula.Rda")

#tutto=union(elmir_seurat_5@assays$RNA@var.features,row.names(result))
tutto=row.names(result)
raw_small=raw_counts[tutto,]

setwd("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/CIARA_archive/CIARA_old/inst/extdata") 

raw_counts_human_ciara=raw_small
save(raw_counts_human_ciara,file="raw_counts_human_data.Rda")
```
...
close(gz1)
setwd("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/CIARA_archive/CIARA_old/inst/extdata")
saveRDS(raw_counts, file = "my_data.rds")
...
setwd("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/CIARA_archive/CIARA_old/inst/extdata") 
save(raw_small,file="raw_small.Rda")
hvg_human_gastrula=elmir_seurat_5@assays$RNA@var.features
setwd("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/CIARA_archive/CIARA_old/inst/extdata")
save(hvg_human_gastrula,file="hvg_human_gastrula.Rda")

bo=apply(raw_counts,1,sum)
```
...
setwd("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/CIARA_archive/CIARA_old/inst/extdata")
save(raw_elmir_5_30,file="raw_elmir_compress.Rda",compress="xz")
...
```{r }
setwd("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/CIARA_archive/CIARA_old/inst/extdata")
norm_human_data_ciara=norm_elmir_5_30[ciara_genes, ]
save(norm_human_data_ciara,file="norm_human_data_ciara.Rda")
```
