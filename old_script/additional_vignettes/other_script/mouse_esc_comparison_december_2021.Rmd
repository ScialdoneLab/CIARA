...
geni_top=row.names(result)[result[,1]<0.000001&result[,2]==0]
```
...
top_1=white_black_marker(final_cluster_version_sub,"1-step_2",norm_counts_ane_24_update,marker_all_day_24_first,1)
...
IDENTOM::Plot_balons(norm_counts_ane_24_update,final_cluster_version_sub,top_1,length(top_1),max_size=5,text_size=10)
...
top_2=white_black_marker(final_cluster_version_sub,"2-step_2",norm_counts_ane_24_update,marker_all_day_24_first,1)
...
IDENTOM::Plot_balons(norm_counts_ane_24_update,final_cluster_version_sub,top_2,length(top_2),max_size=5,text_size=10)
...
listInput <- list(entropy_genes=entropy_genes,haystack_genes=haystack_gene)
