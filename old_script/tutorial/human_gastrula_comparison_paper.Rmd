...
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/gini_select.pdf",width = 8,height = 6)
...
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/ciara_select.pdf",width = 8,height = 6)
ggplot(mtcars, aes(x=max_gini, y=gini_value, color=label_all)) +
  geom_point()+xlab("log2 (Max Expression Level)")+ylab("Gini index")+labs(color="Type")+geom_rect(aes(ymin = y_min , ymax = y_max, xmin = x_min , xmax = x_max ),
               fill = "transparent", color = "black")+theme(text = element_text(size=16))
