...
##old impplementation
```{r }
plot_genes_sum_here_old=function (coordinate_umap, norm_counts, color_cell, name_title) 
{
    index_sort <- order(color_cell)
    row.names(coordinate_umap) <- colnames(norm_counts)
    coordinate_umap <- coordinate_umap[colnames(norm_counts)[index_sort], 
...
```{r }
#pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/qc_after_CIARA_1.pdf")
...
p=plot_interactive_here(cordinate_umap_24_update,norm_counts_ane_24_update,rank_intersect,genes_name_text,hm.colors,min_x=NULL,max_x=NULL,min_y=NULL,max_y=NULL)
htmlwidgets::saveWidget(p, file = "mouse_esc.html")

pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/interactive_plot/mouse_esc.pdf",width = 8,height = 6)
p=plot_genes_sum_here(cordinate_umap_24_update,norm_counts_ane_24_update,rank_intersect,"Top genes CIARA",hm.colors)
...
```{r }
a=Plot_qc_cluster(mayra_seurat_24_update,final_cluster_version_sub,"mt-","Rps","Rpl")
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/qc_after_CIARA_1.pdf")
a[[1]]+theme(text = element_text(size=18))+xlab("Cluster")
dev.off()
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/qc_after_CIARA_2.pdf")
a[[2]]+theme(text = element_text(size=18))+xlab("Cluster")
dev.off()
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/qc_after_CIARA_3.pdf")
a[[3]]+theme(text = element_text(size=18))+xlab("Cluster")
dev.off()
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/qc_after_CIARA_4.pdf")
...
plot_balloon_marker_norm(norm_counts_ane_24_update,final_cluster_version_sub,c(top_0[1:5],c(top_1[1:4],top_1[8]),top_2[1:5]),5,max_size=5,text_size=10)
```
...
```{r}
DefaultAssay(mayra_seurat_0) <- "RNA"
markers_first_elmir=markers_cluster_seurat(mayra_seurat_0,as.vector(mayra_0_ciara$RNA_snn_res.0.1),names(mayra_seurat_0$RNA_snn_res.0.1),5)
```
...
```{r}
test=Test_Fisher(final_cluster_version_sub,marker_all_day_24_first,marker_all_day_0_first_2)
test[[2]][test[[1]]<0.05&test[[2]]>2]
```
...
listInput <- list(mouse_48h_differentiation=marker_1_small,mouse_24h_differentiation=marker_all_day_24_first_2, mouse_0h_differentiation=marker_all_day_0_first_2)

pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figure_3/fig_3_e_extra.pdf")
upset(fromList(listInput), order.by = "freq")
...
```{r }
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/localized_gene_mouse_esc.pdf",width = 8, height = 6)
...
dev.off()
#plot_gene(norm_counts_ane_0,cordinate_umap_0,"AC147512.2","AC147512.2")

pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/not_localized_gene_mouse_esc.pdf", width = 8, height = 6)
...
setwd("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/interactive_plot")
p=plot_interactive_here(cordinate_umap_0,norm_counts_ane_0,rank_intersect,genes_name_text,hm.colors,min_x=NULL,max_x=NULL,min_y=NULL,max_y=NULL)
htmlwidgets::saveWidget(p, file = "mouse_esc_0h.html")

pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/interactive_plot/mouse_esc_0h.pdf",width = 8,height = 6)
p=plot_genes_sum_here(cordinate_umap_0,norm_counts_ane_0,rank_intersect,"Top 100 genes CIARA",hm.colors)
p+theme_bw()+theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),axis.text.y=element_blank(),
        axis.ticks.y=element_blank())+theme(text = element_text(size=12))+geom_point( alpha = 0.3, na.rm = T, shape = 21, colour = "black",stroke=0.1)
...
find_resolution(mayra_0_ciara,seq(0.001,0.1,0.01))
...
```{r }
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/marker_cluster_1_mouse_esc.pdf",width = 8, height = 6)
...
```{r }
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/supplementary_figures/marker_cluster_2_mouse_esc.pdf",width = 8,height = 6)
...
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figure_1/marker_plot.pdf",width = 8, height = 6)
plot_balloon_marker(norm_counts_ane_0,as.vector(mayra_0_ciara$RNA_snn_res.0.1),c(top_0[1:3],top_1[1:3],top_2[1:3]),3,max_size=5,text_size=10)
dev.off()
##Norm version
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figure_1/marker_plot_norm.pdf",width = 8, height = 6)
plot_balloon_marker_norm(norm_counts_ane_0,as.vector(mayra_0_ciara$RNA_snn_res.0.1),c(top_0[1:3],top_1[1:3],top_2[1:3]),3,max_size=5,text_size=10)
dev.off()
```


```{r }
plot_balloon_marker(norm_counts_ane_0,as.vector(mayra_0_ciara$RNA_snn_res.0.1),c(top_0[1:3],top_1[1],top_1[18],top_1[30],top_2[7],top_2[17],top_2[11]),3,max_size=5,text_size=10)


#plot_balloon_marker_norm(norm_counts_ane_0,as.vector(mayra_0_ciara$RNA_snn_res.0.1),c(top_0[1:3],top_1[1],top_1[18],top_1[30],top_2[7],top_2[17],top_2[11]),3,max_size=5,text_size=10)
```

```{r }
plot_balloon_marker(norm_counts_ane_0,as.vector(mayra_0_ciara$RNA_snn_res.0.1),marker_all_day_24_first,5,max_size=5,text_size=10)
```
...
pdf("/Users/gabriele.lubatti/Desktop/Phd/entropy_of_mixing_library/github_january_2022/figures_paper/figures_conference/dendogram_0_24_48.pdf",width=8,height = 6)
hc <- hclust(my.dist)
